...
describe('ConverterForm', () => {
  ...
  it('should render the refresh button after the currency selectors', () => {
    render(<ConverterForm {...defaultProps} />);
  ...
  it('should disable the refresh button while refreshing', () => {
    render(<ConverterForm {...defaultProps} refreshing />);
  ...
  it('should display validation error below the input row', () => {
    ...
    expect(errorElement).toHaveClass('text-alert');
  });
